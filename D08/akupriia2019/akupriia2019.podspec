...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'vogsphere@vogsphere-2.unit.ua:intra/2019/activities/piscine_swift_ios_day_08/akupriia2'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ArtemisKS' => 'Artemkupriyanets@yahoo.com' }
  s.source           = { :git => 'vogsphere@vogsphere-2.unit.ua:intra/2019/activities/piscine_swift_ios_day_08/akupriia2', :tag => s.version.to_s }
